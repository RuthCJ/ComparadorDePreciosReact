...
function Comparador() {
    ...
    let [productosMasBaratos, setProductosMasBaratos] = useState([]);
    ...
    const listaMasBaratos = () => {
        ...
        for (let i = 0; i < nombresDeProductos.length; i++) {
            let obtenerProductosRepetidos = obtenerRepetidos(nombresDeProductos[i]).slice();// se obtiene la lista de los productos de un mismo tipo  
